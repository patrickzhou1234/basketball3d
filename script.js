...
var createScene = function () {
    ...
    groundmat.diffuseTexture = new BABYLON.Texture("https://i.imgur.com/PKfiomM.png", scene);
    ...
    pole.physicsImpostor = new BABYLON.PhysicsImpostor(pole, BABYLON.PhysicsImpostor.MeshImpostor, {mass:0, restitution:0.5}, scene);

    var redmat = new BABYLON.StandardMaterial("redmat", scene);
    redmat.diffuseColor = new BABYLON.Color3(1, 0, 0);

    hoop = BABYLON.MeshBuilder.CreateTorus("hoop", {diameter:2, thickness:0.3}, scene);
    hoop.position.set(0, 10, 12.5);
    hoop.physicsImpostor = new BABYLON.PhysicsImpostor(hoop, BABYLON.PhysicsImpostor.MeshImpostor, {mass:0, restitution:0.2}, scene);
    hoop.material = redmat;

    var backboardmat = new BABYLON.StandardMaterial("backboardmat", scene);
    backboardmat.diffuseTexture = new BABYLON.Texture("https://i.imgur.com/C8OogbR.png", scene);

    var backboard = BABYLON.MeshBuilder.CreateBox("backboard", {depth:0.5, height:4, width:5}, scene);
    backboard.position.set(0, 12, 14.5);
    backboard.physicsImpostor = new BABYLON.PhysicsImpostor(backboard, BABYLON.PhysicsImpostor.BoxImpostor, {mass:0, restitution:0.5}, scene);
...
canvas.onclick = function() {
    ...
    var basketballmat = new BABYLON.StandardMaterial("basketball", scene);
    basketballmat.diffuseTexture = new BABYLON.Texture("https://i.imgur.com/9L5J8DF.png", scene);
    ...
    bullet.physicsImpostor.applyImpulse(impulseDir.scale(5.5), bullet.getAbsolutePosition());
    bullet.setParent(null);
    bullet.material = basketballmat;
}
...
function muteorplay() {
  if (document.getElementById("soundcontrol").src == "https://i.imgur.com/ken5lnJ.png") {
    document.getElementById("themesong").pause();
    document.getElementById("soundcontrol").src = "https://i.imgur.com/1DydBNF.png";
  } else {
    document.getElementById("themesong").play();
    document.getElementById("soundcontrol").src = "https://i.imgur.com/ken5lnJ.png";
  }
}
